...
@user1.save
Event.create(user_id: @user1.id, course_id: @course1.id, activity_access: "2022-07-18 00:00:00", submitted_time: "2022-07-18 01:00:00")
@course1.users << @user1

@user2 = User.new(email: "v00e0002@oita-u.ac.jp", name: "v00e0002 student2", password: "v00e0002", role: "Student", student_id: "v00e0002")
@user2.save
Event.create(user_id: @user2.id, course_id: @course1.id, activity_access: "2022-07-18 00:00:00", submitted_time: "2022-07-18 01:00:00")
@course1.users << @user2

@user3 = User.new(email: "v00e0003@oita-u.ac.jp", name: "v00e0003 student3", password: "v00e0003", role: "Student", student_id: "v00e0003")
@user3.save
Event.create(user_id: @user3.id, course_id: @course1.id, activity_access: "2022-07-18 00:00:00")
@course1.users << @user3
...
@user4.save
Event.create(user_id: @user4.id, course_id: @course1.id, activity_access: "2022-07-18 00:00:00", submitted_time: "2022-07-18 01:00:00")
@course1.users << @user4

@user5 = User.new(email: "v00e0005@oita-u.ac.jp", name: "v00e0005 student5", password: "v00e0005", role: "Student", student_id: "v00e0005")
@user5.save
Event.create(user_id: @user5.id, course_id: @course2.id, activity_access: "2022-07-18 00:00:00", submitted_time: "2022-07-18 01:00:00")
@course2.users << @user5

@user6 = User.new(email: "v00e0006@oita-u.ac.jp", name: "v00e0006 student6", password: "v00e0006", role: "Student", student_id: "v00e0006")
@user6.save
Event.create(user_id: @user6.id, course_id: @course2.id, activity_access: "2022-07-18 00:00:00")
@course2.users << @user6